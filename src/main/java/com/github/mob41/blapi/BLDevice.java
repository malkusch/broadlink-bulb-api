...
public abstract class BLDevice implements Closeable {
    ...
    public static final short DEV_LB1 = -56;
    ...
    public static final String DESC_LB1 = "Smart Bulb";
    ...
    protected BLDevice(short deviceType, String deviceDesc, String host, Mac mac) throws IOException {
        ...
        var localInterface = InetAddress.getByName("192.168.188.73");
        sock = new DatagramSocket(0, localInterface);
        sock.setReuseAddress(true);
        
        var isLocal = localInterface.isAnyLocalAddress();
        
        // sock.connect(InetAddress.getByName(host), 80);
    ...
    public DatagramPacket sendCmdPkt(int timeout, CmdPayload cmdPayload) throws IOException {
        return sendCmdPkt(InetAddress.getByName("192.168.188.73"), 0, timeout, 1024, cmdPayload);
    }
    ...
    public DatagramPacket sendCmdPkt(int timeout, int bufSize, CmdPayload cmdPayload) throws IOException {
        return sendCmdPkt(InetAddress.getByName("192.168.188.73"), 0, timeout, bufSize, cmdPayload);
    }
    ...
    public static String getDescOfType(short devType){
        ...
        case BLDevice.DEV_LB1:
            return BLDevice.DESC_LB1;
        //
        // Unregonized
        //
        default:
